from sqlalchemy import Time,Date,Boolean, Column, ForeignKey, Integer, String
...
class Add(Base):
    ...
    add_id = Column(Integer, primary_key=True, index=True, default=1,autoincrement=True)
    ...
    item = relationship("Item", back_populates="add")
    employee = relationship("Employee", back_populates="add")
